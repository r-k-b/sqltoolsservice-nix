# copied from https://github.com/NixOS/nixpkgs/blob/1d08ea2bd83abef174fb43cbfb8a856b8ef2ce26/pkgs/development/compilers/dotnet/build-dotnet.nix
# (can we avoid copying this file, get it straight from the pkgs arg?)
{ type, version, srcs }:

assert builtins.elem type [ "aspnetcore" "runtime" "sdk" ];

{ lib, stdenv, fetchurl, writeText, libunwind, openssl, icu, libuuid, zlib, curl
, lttng-ust_2_12 }:
...
in stdenv.mkDerivation rec {
  ...
  rpath = lib.makeLibraryPath ([
    ...
    libuuid
    openssl
  ] ++ lib.optionals stdenv.isLinux [ lttng-ust_2_12 ]);
